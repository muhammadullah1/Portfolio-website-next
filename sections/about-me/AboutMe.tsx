...
const AboutMe = () => {
  ...
  My passion for technology led me to pursue a career as a software engineer. It felt like the perfect choice considering my educational background, but I often craved more excitement.
</m.h3>
<m.h3 variants={childAnimation} className="about-me-text">
  It was during my university years that I discovered my true love for technology. Programming fascinated me, and writing my first Hello World program in C language ignited my passion.
</m.h3>
<m.h3 variants={childAnimation} className="about-me-text">
  Since then, my desire to become a software engineer has grown even stronger. I am driven by my love for technology and the dynamic nature of the field. Combining problem-solving skills with creativity, software engineering is the perfect fit for me.
</m.h3>
        ...
        >
          Graduated Bs.Computer Science. from{' '}
          <Link
            aria-label="SIT"
            href="https://www.icp.edu.pk/"
            rel="noreferrer"
            target="_blank"
